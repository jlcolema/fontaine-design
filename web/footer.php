    ...
    <div id="footer-container">
        ...
        <div id="footer" class="clearfix">
            ...
            <p class="copyright">&copy; Copyright <?php echo date( 'Y' ); ?>. <?php _e('Powered by', 'framework') ?> <a href="http://wordpress.org/">WordPress</a>.<br /><a href="http://www.themezilla.com/themes/classica">Classica Theme</a> by <a href="http://www.themezilla.com">ThemeZilla</a></p>
