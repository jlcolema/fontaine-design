                        ...
                        <div <?php post_class(); ?> id="post-<?php the_ID(); ?>">
                            ...
                            <div id="slider" class="clearfix">
                                ...
                                <div class="slides_container">
									...
									?>
                                    <div><img height="<?php echo $height; ?>" src="<?php echo get_post_meta(get_the_ID(), 'upload_image', true); ?>" alt="<?php the_title(); ?>"></div>
                                    <?php endif; ?>
                                    <?php if(get_post_meta(get_the_ID(), 'upload_image2', true) != '') : ?>
                                    <div><img src="<?php echo get_post_meta(get_the_ID(), 'upload_image2', true); ?>" alt="<?php the_title(); ?>"></div>
                                    <?php endif; ?>
                                    <?php if(get_post_meta(get_the_ID(), 'upload_image3', true) != '') : ?>
                                    <div><img src="<?php echo get_post_meta(get_the_ID(), 'upload_image3', true); ?>" alt="<?php the_title(); ?>"></div>
                                    <?php endif; ?>
                                    <?php if(get_post_meta(get_the_ID(), 'upload_image4', true) != '') : ?>
                                    <div><img src="<?php echo get_post_meta(get_the_ID(), 'upload_image4', true); ?>" alt="<?php the_title(); ?>"></div>
                                    <?php endif; ?>
                                    <?php if(get_post_meta(get_the_ID(), 'upload_image5', true) != '') : ?>
                                    <div><img src="<?php echo get_post_meta(get_the_ID(), 'upload_image5', true); ?>" alt="<?php the_title(); ?>"></div>
                                    <?php endif; ?>
                                    <?php if(get_post_meta(get_the_ID(), 'upload_image6', true) != '') : ?>
                                    <div><img src="<?php echo get_post_meta(get_the_ID(), 'upload_image6', true); ?>" alt="<?php the_title(); ?>"></div>
                                    <?php endif; ?>
                                    <?php if(get_post_meta(get_the_ID(), 'upload_image7', true) != '') : ?>
                                    <div><img src="<?php echo get_post_meta(get_the_ID(), 'upload_image7', true); ?>" alt="<?php the_title(); ?>"></div>
                                    <?php endif; ?>
                                    <?php if(get_post_meta(get_the_ID(), 'upload_image8', true) != '') : ?>
                                    <div><img src="<?php echo get_post_meta(get_the_ID(), 'upload_image8', true); ?>" alt="<?php the_title(); ?>"></div>
                                    <?php endif; ?>
                                    <?php if(get_post_meta(get_the_ID(), 'upload_image9', true) != '') : ?>
                                    <div><img src="<?php echo get_post_meta(get_the_ID(), 'upload_image9', true); ?>" alt="<?php the_title(); ?>"></div>
                                    <?php endif; ?>
                                    <?php if(get_post_meta(get_the_ID(), 'upload_image10', true) != '') : ?>
                                    <div><img src="<?php echo get_post_meta(get_the_ID(), 'upload_image10', true); ?>" alt="<?php the_title(); ?>"></div>
                                    <?php endif; ?>
